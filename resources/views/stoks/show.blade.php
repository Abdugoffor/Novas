                        ...
                        @foreach ($models as $model)
                            @foreach ($model->material_stok_values as $material_stok_value)
                                <tr>
                                    ...
                                    <td>{{ $material_stok_value->quantity }}</td>
                                    <td>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" id="Value" name="quantity"
                                                                    ...
                                                                    class="form-control"
                                                                    placeholder="Max quantity ({{ $material_stok_value->quantity }})">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleFormControlSelect1">Material
                                                                    Stok</label>
                                                                <select class="form-control" name="to_id"
                                                                    id="exampleFormControlSelect1">
                                                                    <option selected="" disabled="">Material Stok
                                                                    </option>

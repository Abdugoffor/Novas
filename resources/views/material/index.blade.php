...
@section('title', 'Material Coming list')
...
@section('con')
    ...
    <div class="content pt-0 mt-5">
        ...
        @if (Auth::user()->hasPermissionTo('user.create'))
            <button type="button" class="btn btn-light mb-2" data-toggle="modal" data-target="#modal_default">Material
                create</button>
        @endif
        @if ($errors->any())
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('material.create') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <input type="text" name="name" class="form-control" placeholder="Mame">
                            </div>
                        </div>
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h5 class="card-title">Material Coming list</h5>
            </div>
